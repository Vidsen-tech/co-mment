...
const workshopData = {
    hr: {
        ...
        modalContent: { modalTitle: 'Upit za Radionicu', nameLabel: 'Ime i prezime', namePlaceholder: 'Npr. Linda Lindić', contactLabel: 'Email ili telefon', contactPlaceholder: 'Npr. linda.lindic@email.com', messageLabel: 'Vaša poruka', messagePlaceholder: 'Ovdje napišite vašu poruku...', sendButton: 'Pošalji upit', sendingButton: 'Slanje...', successMessage: 'Upit uspješno poslan!', closeButton: 'Zatvori' },
        sessions: [
