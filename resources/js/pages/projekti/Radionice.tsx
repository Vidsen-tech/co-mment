...
const workshopData = {
    hr: {
        ...
        modalContent: { modalTitle: 'Upit za Radionicu', nameLabel: 'Ime i prezime', namePlaceholder: 'Npr. Ana Anić', contactLabel: 'Email ili telefon', contactPlaceholder: 'Npr. ana.anic@email.com', messageLabel: 'Vaša poruka', messagePlaceholder: 'Ovdje napišite vašu poruku...', sendButton: 'Pošalji upit', sendingButton: 'Slanje...', successMessage: 'Upit uspješno poslan!', closeButton: 'Zatvori' },
        sessions: [
    ...
    en: {
        ...
        modalContent: { modalTitle: 'Workshop Inquiry', nameLabel: 'Full Name', namePlaceholder: 'E.g., John Doe', contactLabel: 'Email or Phone', contactPlaceholder: 'E.g., john.doe@email.com', messageLabel: 'Your Message', messagePlaceholder: 'Write your message here...', sendButton: 'Send Inquiry', sendingButton: 'Sending...', successMessage: 'Inquiry Sent Successfully!', closeButton: 'Close' },
        sessions: [
...
export default function Radionice() {
    ...
    return (
        <>
            ...
            >
                <div className="pointer-events-none absolute inset-0 transition-opacity duration-300 z-0" style={{ background: `radial-gradient(800px circle at var(--mouse-x) var(--mouse-y), hsl(var(--primary) / 0.15), transparent 80%)` }} aria-hidden="true" />
